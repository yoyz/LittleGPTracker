#ifndef GCWZERO_GUI_WINDOW_H_
#define GCWZERO_GUI_WINDOW_H_

#include "UIFramework/Interfaces/I_GUIWindowImp.h"
#include <SDL/SDL.h>
#include "Adapters/GCWZEROSystem/GCWZEROEventQueue.h"

bool ProcessGCWZEROEvent(GCWZEROEvent &event) ;
...
class GCWZEROGUIWindowImp: public I_GUIWindowImp {

public:

	GCWZEROGUIWindowImp(GUICreateWindowParams &p) ;
	virtual ~GCWZEROGUIWindowImp() ;
